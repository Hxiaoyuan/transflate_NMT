...
def preprocess_opts(parser):
    ...
    group.add('--train_src', '-train_src', required=False, nargs='+',
              default=['D:/Project/PythonProject/DeepLearning/Git/OpenNMT-py-master/data/src-train.txt'],
              help="Path(s) to the training source data")
    group.add('--train_tgt', '-train_tgt', required=False, nargs='+',
              default=['D:/Project/PythonProject/DeepLearning/Git/OpenNMT-py-master/data/tgt-train.txt'],
    ...
    group.add('--valid_src', '-valid_src',
              default='D:/Project/PythonProject/DeepLearning/Git/OpenNMT-py-master/data/src-val.txt',
              help="Path to the validation source data")
    group.add('--valid_tgt', '-valid_tgt',
              default='D:/Project/PythonProject/DeepLearning/Git/OpenNMT-py-master/data/tgt-val.txt',
    ...
    group.add('--save_data', '-save_data', required=False,
              default='D:/Project/PythonProject/DeepLearning/Git/OpenNMT-py-master/data/demo',
...
def translate_opts(parser):
    ...
    group.add('--replace_unk', '-replace_unk', action="store_true", default="-verbose",
