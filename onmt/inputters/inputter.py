...
def get_fields(
    ...
    assert config.src_data_type == 'text', \
    ...
    src_field_kwargs = {"n_feats": n_src_feats,
                        ...
                        "base_name": "src"}
    fields["src"] = fields_getters[config.src_data_type](**src_field_kwargs)
    ...
    tgt_field_kwargs = {"n_feats": n_tgt_feats,
                        ...
                        "base_name": "tgt"}
    fields["tgt"] = fields_getters[config.src_data_type](**tgt_field_kwargs)
...
def build_noise_field(src_field, subword=True,
    ...
    word_start_mask = torch.zeros([vocab_size])
    # end_of_sentence_mask = torch.zeros([vocab_size]).bool()
    end_of_sentence_mask = torch.zeros([vocab_size])
